...
foreach ($posts as $post) {
    ...
    <div style="margin:15px; border:3px solid black">
        <?php
            ...
            ?>
            <div>
                <input type="submit" name="Supprimer" class="button" value="Supprimer" /> <?php //Associer fonction DELETE COMMENT ?>
                <input type="submit" name="Modifier" class="button" value="Modifier" /> <?php //Associer fonction UPDATE COMMENT ?>
            </div>
    </div>
    <?php
}
